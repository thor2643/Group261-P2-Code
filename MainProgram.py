...
bottom_orient = 0  #-robomath.pi/2

pcb_pos = [180, 400, 0]
pcb_orient = 0 #-robomath.pi/2

fuse_pos = [350, 400, 100] 
fuse_orient = 0 #-robomath.pi/2

top_pos = [550, 300, 0]
top_orient = -robomath.pi/4 #-robomath.pi/2
